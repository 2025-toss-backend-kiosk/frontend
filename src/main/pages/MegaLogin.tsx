...
const MegaLogin: React.FC = () => {
  ...
  // 개별 약관 동의
  const handleCheck = (k: keyof typeof checks) => {
    const upd = { ...checks, [k]: !checks[k] };
    setChecks(upd);
    setAllChecked(Object.values(upd).every(b => b));
  };
  ...
  return (
    <div className="loginscreen">
      ...
      <div className="login-form">
        ...
        <div className="agreement-section">
          ...
          <div className="promise-section">
            <p className="promise">개인정보 수집</p>
            <div className="promise2">
              목적 : 적립, 쿠폰 사용 및 취소 정보, CS신청정보 <br/>
              항목 : 휴대전화번호 <br/>
      ...
      <button
        ...
        disabled={!isVerified || !allChecked}
      >
        로그인/회원가입
      </button>
    </div>
